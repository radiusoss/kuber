...
func DeleteCmd() *cobra.Command {
	...
	deleteCmd.Flags().StringVarP(&do.StateStorePath, "state-store-path", "S", strEnvDef("KUBICORN_STATE_STORE_PATH", util.GetUserHome()+"/.datalayer/kubicorn/_state"), "The state store path to use")
