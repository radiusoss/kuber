...
var (
	argInsecurePort        = pflag.Int("insecure-port", 9091, "The port to listen to for incoming HTTP requests.")
	...
	argsAzureApplicationId = pflag.String("azure-application-id", "f145fb87-901d-4519-ad39-573c30770e6f", "")
	argsAzureRedirect      = pflag.String("azure-redirect", "http://localhost:4326", "")
	argsAzureScope         = pflag.String("azure-scope", "User.ReadBasic.All+Contacts.Read+Mail.Send+Files.ReadWrite+Notes.ReadWrite", "")
	argsKuberPlane         = pflag.String("kuber-plane", "http://localhost:4326", "")
	argsKuberRest          = pflag.String("kuber-rest", "http://localhost:9091", "")
	argsKuberWs            = pflag.String("kuber-ws", "ws://localhost:9091", "")
	argsSpitfireRest       = pflag.String("spitfire-rest", "http://localhost:8091", "")
	argsSpitfireWs         = pflag.String("spitfire-ws", "ws://localhost:8091", "")
	argsHdfs               = pflag.String("hdfs", "http://localhost:50070", "")
	argsTwitterRedirect    = pflag.String("twitter-redirect", "http://datalayer-001:8081/twitter/maketoken", "")
)
...
func serve() {
	...
	viper.BindPFlag("azureapplicationid", pflag.CommandLine.Lookup("azure-application-id"))
	viper.BindPFlag("azureredirect", pflag.CommandLine.Lookup("azure-redirect"))
	viper.BindPFlag("azurescope", pflag.CommandLine.Lookup("azure-scope"))
	viper.BindPFlag("kuberplane", pflag.CommandLine.Lookup("kuber-plane"))
	viper.BindPFlag("kuberrest", pflag.CommandLine.Lookup("kuber-rest"))
	viper.BindPFlag("kuberws", pflag.CommandLine.Lookup("kuber-ws"))
	viper.BindPFlag("spitfirerest", pflag.CommandLine.Lookup("spitfire-rest"))
	viper.BindPFlag("spitfirews", pflag.CommandLine.Lookup("spitfire-ws"))
	viper.BindPFlag("hdfs", pflag.CommandLine.Lookup("hdfs"))
	viper.BindPFlag("twitterredirect", pflag.CommandLine.Lookup("twitter-redirect"))
